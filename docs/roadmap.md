...
- [ ] <!-- workspace:id=work:4a5b42d0-5df1-5eed-81ca-e823c067d312 --> **Epoch dates in Receipt, Spreadsheet, Polaroid and Manuscript mastheads** render "1970-01-01" on the live build; confirm against HEAD and fix the date source if it persists.
- [ ] <!-- workspace:id=work:c1013aa5-5d7b-54cf-a9cb-c7d859faf9a0 --> **Receipt edition Lookup right column spills past the paper edge** at 1280 wide.
...
- [ ] <!-- workspace:id=work:17af5ab9-196d-56f7-b57b-654167fc9501 --> **Competition small fixes**: Escape does not close Manage Phases; Generate is a silent no-op on a phase with no boards and drops boards with 0 bouts without warning; "Remove" on board headers clips to "REMOV" at 390px; "1 cells knocked" plural.
