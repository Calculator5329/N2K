...
- [ ] <!-- workspace:id=work:24fbae85-9bf9-53b8-b97b-7bc628f8b80b --> **Only the Lookup view is in the URL hash**: Back leaves the site from Competition, Library and Play, reload always lands on Lookup, and non-Lookup views cannot be linked.
